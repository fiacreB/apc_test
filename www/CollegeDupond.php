...
if (isset($_POST['Troisieme'])) {
  ...
  $req= $db->prepare('SELECT * FROM documentations WHERE etablissement="Collège Dupond" and classe="Troisième"  ORDER BY matiere ');
  $req->execute();
...
elseif (isset($_POST['Premiere_C'])) {
  extract($_POST);
  require_once ('base_corri.php');
  $req= $db->prepare('SELECT * FROM documentations WHERE etablissement="Collège Dupond" and classe="Première C"  ORDER BY matiere ');
  $req->execute();
  while($reponse = $req->fetch(PDO::FETCH_OBJ)){
      ?> 
       <div id="download" class="bg-white my-2">
  ...
  extract($_POST);
  require_once ('base_corri.php');
  $req= $db->prepare('SELECT * FROM documentations WHERE etablissement="Collège Dupond" and classe="Première D"  ORDER BY matiere ');
  $req->execute();
  while($reponse = $req->fetch(PDO::FETCH_OBJ)){
      ?> 
       <div id="download" class="bg-white my-2">
  ...
  extract($_POST);
  require_once ('base_corri.php');
  $req= $db->prepare('SELECT * FROM documentations WHERE etablissement="Collège Dupond" and classe="Première TI"  ORDER BY matiere ');
  $req->execute();
  while($reponse = $req->fetch(PDO::FETCH_OBJ)){
      ?> 
       <div id="download" class="bg-white my-2">
  ...
  extract($_POST);
  require_once ('base_corri.php');
  $req= $db->prepare('SELECT * FROM documentations WHERE etablissement="Collège Dupond" and classe="Première A"  ORDER BY matiere ');
  $req->execute();
  while($reponse = $req->fetch(PDO::FETCH_OBJ)){
      ?> 
       <div id="download" class="bg-white my-2">
  ...
  extract($_POST);
  require_once ('base_corri.php');
  $req= $db->prepare('SELECT * FROM documentations WHERE etablissement="Collège Dupond" and classe="Terminale C"  ORDER BY matiere ');
  $req->execute();
  while($reponse = $req->fetch(PDO::FETCH_OBJ)){
      ?> 
       <div id="download" class="bg-white my-2">
  ...
  extract($_POST);
  require_once ('base_corri.php');
  $req= $db->prepare('SELECT * FROM documentations WHERE etablissement="Collège Dupond" and classe="Terminale D"  ORDER BY matiere ');
  $req->execute();
  while($reponse = $req->fetch(PDO::FETCH_OBJ)){
      ?> 
       <div id="download" class="bg-white my-2">
  ...
  extract($_POST);
  require_once ('base_corri.php');
  $req= $db->prepare('SELECT * FROM documentations WHERE etablissement="Collège Dupond" and classe="Terminale TI"  ORDER BY matiere ');
  $req->execute();
  while($reponse = $req->fetch(PDO::FETCH_OBJ)){
      ?> 
       <div id="download" class="bg-white my-2">
  ...
  extract($_POST);
  require_once ('base_corri.php');
  $req= $db->prepare('SELECT * FROM documentations WHERE etablissement="Collège Dupond" and classe="Terminale A"  ORDER BY matiere ');
  $req->execute();
  while($reponse = $req->fetch(PDO::FETCH_OBJ)){
      ?> 
       <div id="download" class="bg-white my-2">
...
<?php } 
        ...
        $req= $db->prepare('SELECT * FROM documentations WHERE etablissement="Collège Dupond" ORDER BY classe ');
        $req->execute();
        while($reponse = $req->fetch(PDO::FETCH_OBJ)){
            ?> 
             <div id="download" class="bg-white my-2">
