...
<nav class="mc-navbar navbar navbar-expand-lg position-fixed navbar-dark pe-3 w-100">
    ...
    <section class="banner d-flex  align-items-center pt-">
      ...
      <h1 class="title-niv-1 text-white">les différents td du site :</h1>
...
if (isset($_POST['Troisieme'])) {
  extract($_POST);
  $req= $db->prepare('SELECT * FROM autres_doc WHERE classe="Troisième"  and reference="td" ORDER BY matiere ');
  $req->execute();
  while($reponse = $req->fetch(PDO::FETCH_OBJ)){
      ?> 
       ...
       <div id="download_epreuve">
                                <a href="supprime_td.php?id=<?php echo $reponse->id; ?>">
...
elseif (isset($_POST['Premiere_C'])) {
  extract($_POST);
  $req= $db->prepare('SELECT * FROM autres_doc WHERE  classe="Première C"  and reference="td" ORDER BY matiere ');
  $req->execute();
  while($reponse = $req->fetch(PDO::FETCH_OBJ)){
      ?> 
       <div id="download" class="bg-white my-2">
  ...
  extract($_POST);
  $req= $db->prepare('SELECT * FROM autres_doc WHERE  classe="Première D"  and reference="td" ORDER BY matiere ');
  $req->execute();
  while($reponse = $req->fetch(PDO::FETCH_OBJ)){
      ?> 
       <div id="download" class="bg-white my-2">
  ...
  extract($_POST);
  $req= $db->prepare('SELECT * FROM autres_doc WHERE classe="Première TI"  and reference="td" ORDER BY matiere ');
  $req->execute();
  while($reponse = $req->fetch(PDO::FETCH_OBJ)){
      ?> 
       <div id="download" class="bg-white my-2">
  ...
  extract($_POST);
  $req= $db->prepare('SELECT * FROM autres_doc WHERE  classe="Première A"  and reference="td" ORDER BY matiere ');
  $req->execute();
  while($reponse = $req->fetch(PDO::FETCH_OBJ)){
      ?> 
       <div id="download" class="bg-white my-2">
  ...
  extract($_POST);
  $req= $db->prepare('SELECT * FROM autres_doc WHERE  classe="Terminale C"  and reference="td" ORDER BY matiere ');
  $req->execute();
  while($reponse = $req->fetch(PDO::FETCH_OBJ)){
      ?> 
       <div id="download" class="bg-white my-2">
  ...
  extract($_POST);
  $req= $db->prepare('SELECT * FROM autres_doc WHERE  classe="Terminale D"  and reference="td" ORDER BY matiere ');
  $req->execute();
  while($reponse = $req->fetch(PDO::FETCH_OBJ)){
      ?> 
       <div id="download" class="bg-white my-2">
  ...
  extract($_POST);
  $req= $db->prepare('SELECT * FROM autres_doc WHERE  classe="Terminale TI"  and reference="td" ORDER BY matiere ');
  $req->execute();
  while($reponse = $req->fetch(PDO::FETCH_OBJ)){
      ?> 
       <div id="download" class="bg-white my-2">
  ...
  extract($_POST);
  $req= $db->prepare('SELECT * FROM autres_doc WHERE  classe="Terminale A"  and reference="td" ORDER BY matiere ');
  $req->execute();
  while($reponse = $req->fetch(PDO::FETCH_OBJ)){
      ?> 
       <div id="download" class="bg-white my-2">
...
$req = $db->prepare('SELECT * FROM autres_doc WHERE classe LIKE ? or matiere LIKE ? or matiere LIKE ? or descriptions LIKE ?  and reference="td" ORDER BY classe DESC');
...
<?php } 
          ...
          $req2= $db->prepare('SELECT * FROM autres_doc  WHERE reference="td" ORDER BY matiere ');
        $req2->execute();
        while($reponse = $req2->fetch(PDO::FETCH_OBJ)){
            ?> 
             <div id="download" class="bg-white my-2">
