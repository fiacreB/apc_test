...
<nav class="mc-navbar navbar navbar-expand-lg position-fixed navbar-dark pe-3 w-100">
    ...
    <section class="banner d-flex  align-items-center pt-">
      ...
      <h1 class="title-niv-1 text-white">les différents Boords du site :</h1>
...
if (isset($_POST['Troisieme'])) {
  extract($_POST);
  $req= $db->prepare('SELECT * FROM autres_doc WHERE classe="Troisième"  and reference = "Boords" ORDER BY matiere ');
  $req->execute();
  while($reponse = $req->fetch(PDO::FETCH_OBJ)){
      ?> 
       ...
       <div id="download_epreuve">
                                <a href=supprime_boords.php?id=<?php echo $reponse->id; ?>">
...
elseif (isset($_POST['Premiere_C'])) {
  extract($_POST);
  $req= $db->prepare('SELECT * FROM autres_doc WHERE  classe="Première C"  and reference = "Boords" ORDER BY matiere ');
  $req->execute();
  while($reponse = $req->fetch(PDO::FETCH_OBJ)){
      ?> 
       <div id="download" class="bg-white my-2">
  ...
  extract($_POST);
  $req= $db->prepare('SELECT * FROM autres_doc WHERE  classe="Première D"  and reference = "Boords" ORDER BY matiere ');
  $req->execute();
  while($reponse = $req->fetch(PDO::FETCH_OBJ)){
      ?> 
       <div id="download" class="bg-white my-2">
       ...
       <div id="download_epreuve">
                                <a href="supprime_supprime_boords.php?id=<?php echo $reponse->id; ?>">
                                <button class="btn btn-danger">supprimer</button>
  ...
  extract($_POST);
  $req= $db->prepare('SELECT * FROM autres_doc WHERE classe="Première TI"  and reference = "Boords" ORDER BY matiere ');
  $req->execute();
  while($reponse = $req->fetch(PDO::FETCH_OBJ)){
      ?> 
       <div id="download" class="bg-white my-2">
  ...
  extract($_POST);
  $req= $db->prepare('SELECT * FROM autres_doc WHERE  classe="Première A"  and reference = "Boords" ORDER BY matiere ');
  $req->execute();
  while($reponse = $req->fetch(PDO::FETCH_OBJ)){
      ?> 
       <div id="download" class="bg-white my-2">
  ...
  extract($_POST);
  $req= $db->prepare('SELECT * FROM autres_doc WHERE  classe="Terminale C"  and reference = "Boords" ORDER BY matiere ');
  $req->execute();
  while($reponse = $req->fetch(PDO::FETCH_OBJ)){
      ?> 
       <div id="download" class="bg-white my-2">
  ...
  extract($_POST);
  $req= $db->prepare('SELECT * FROM autres_doc WHERE  classe="Terminale D"  and reference = "Boords" ORDER BY matiere ');
  $req->execute();
  while($reponse = $req->fetch(PDO::FETCH_OBJ)){
      ?> 
       <div id="download" class="bg-white my-2">
  ...
  extract($_POST);
  $req= $db->prepare('SELECT * FROM autres_doc WHERE  classe="Terminale TI"  and reference = "Boords" ORDER BY matiere ');
  $req->execute();
  while($reponse = $req->fetch(PDO::FETCH_OBJ)){
      ?> 
       <div id="download" class="bg-white my-2">
  ...
  extract($_POST);
  $req= $db->prepare('SELECT * FROM autres_doc WHERE  classe="Terminale A"  and reference = "Boords" ORDER BY matiere ');
  $req->execute();
  while($reponse = $req->fetch(PDO::FETCH_OBJ)){
      ?> 
       <div id="download" class="bg-white my-2">
...
$req = $db->prepare('SELECT * FROM autres_doc WHERE classe LIKE ? or matiere LIKE ? or matiere LIKE ? or descriptions LIKE ?  and reference = "Boords" ORDER BY classe DESC');
...
<?php } 
          ...
          $req= $db->prepare('SELECT * FROM autres_doc WHERE reference = "Boords" ORDER BY matiere ');
        $req->execute();
        while($reponse = $req->fetch(PDO::FETCH_OBJ)){
            ?> 
             <div id="download" class="bg-white my-2">
