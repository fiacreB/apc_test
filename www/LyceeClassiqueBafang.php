...
if (isset($_POST['Troisieme'])) {
    ...
    $req = $db->prepare('SELECT * FROM documentations WHERE etablissement="Lycée Classique de Bafang" and classe="Troisième"  ORDER BY matiere ');
    $req->execute();
   ...
   <a href="download_corri.php?id=<?php echo $reponse->id; ?>"> <button class=" btn-primary">corrigé de l'épreuve</button> </a>
    ...
    $req = $db->prepare('SELECT * FROM documentations WHERE etablissement="Lycée Classique de Bafang" and classe="Première C"  ORDER BY matiere ');
    $req->execute();
    while ($reponse = $req->fetch(PDO::FETCH_OBJ)) {
        ?>
       <div id="download" class="bg-white my-2">
   ...
   <a href="download_corri.php?id=<?php echo $reponse->id; ?>"> <button class=" btn-primary">corrigé de l'épreuve</button> </a>
    ...
    $req = $db->prepare('SELECT * FROM documentations WHERE etablissement="Lycée Classique de Bafang" and classe="Première D"  ORDER BY matiere ');
    $req->execute();
    while ($reponse = $req->fetch(PDO::FETCH_OBJ)) {
        ?>
       <div id="download" class="bg-white my-2">
   ...
   <a href="download_corri.php?id=<?php echo $reponse->id; ?>"> <button class=" btn-primary">corrigé de l'épreuve</button> </a>
    ...
    $req = $db->prepare('SELECT * FROM documentations WHERE etablissement="Lycée Classique de Bafang" and classe="Première TI"  ORDER BY matiere ');
    $req->execute();
    while ($reponse = $req->fetch(PDO::FETCH_OBJ)) {
        ?>
       <div id="download" class="bg-white my-2">
   ...
   <a href="download_corri.php?id=<?php echo $reponse->id; ?>"> <button class=" btn-primary">corrigé de l'épreuve</button> </a>
    ...
    $req = $db->prepare('SELECT * FROM documentations WHERE etablissement="Lycée Classique de Bafang" and classe="Première A"  ORDER BY matiere ');
    $req->execute();
    while ($reponse = $req->fetch(PDO::FETCH_OBJ)) {
        ?>
       <div id="download" class="bg-white my-2">
   ...
   <a href="download_corri.php?id=<?php echo $reponse->id; ?>"> <button class=" btn-primary">corrigé de l'épreuve</button> </a>
    ...
    $req = $db->prepare('SELECT * FROM documentations WHERE etablissement="Lycée Classique de Bafang" and classe="Terminale C"  ORDER BY matiere ');
    $req->execute();
    while ($reponse = $req->fetch(PDO::FETCH_OBJ)) {
        ?>
       <div id="download" class="bg-white my-2">
   ...
   <a href="download_corri.php?id=<?php echo $reponse->id; ?>"> <button class=" btn-primary">corrigé de l'épreuve</button> </a>
    ...
    $req = $db->prepare('SELECT * FROM documentations WHERE etablissement="Lycée Classique de Bafang" and classe="Terminale D"  ORDER BY matiere ');
    $req->execute();
    while ($reponse = $req->fetch(PDO::FETCH_OBJ)) {
        ?>
       <div id="download" class="bg-white my-2">
   ...
   <a href="download_corri.php?id=<?php echo $reponse->id; ?>"> <button class=" btn-primary">corrigé de l'épreuve</button> </a>
    ...
    $req = $db->prepare('SELECT * FROM documentations WHERE etablissement="Lycée Classique de Bafang" and classe="Terminale TI"  ORDER BY matiere ');
    $req->execute();
    while ($reponse = $req->fetch(PDO::FETCH_OBJ)) {
        ?>
       <div id="download" class="bg-white my-2">
   ...
   <a href="download_corri.php?id=<?php echo $reponse->id; ?>"> <button class=" btn-primary">corrigé de l'épreuve</button> </a>
    ...
    $req = $db->prepare('SELECT * FROM documentations WHERE etablissement="Lycée Classique de Bafang" and classe="Terminale A"  ORDER BY matiere ');
    $req->execute();
    while ($reponse = $req->fetch(PDO::FETCH_OBJ)) {
        ?>
       <div id="download" class="bg-white my-2">
...
<?php } else {
    ...
    $req = $db->prepare('SELECT * FROM documentations WHERE etablissement="Lycée Classique de Bafang" ORDER BY classe ');
    $req->execute();
    while ($reponse = $req->fetch(PDO::FETCH_OBJ)) {
        ?>
             <div id="download" class="bg-white my-2">
