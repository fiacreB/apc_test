...
<body>
    ...
    if(isset($_POST['valider'],$_POST['matiere'], $_POST['description'],$_POST['reference'],$_POST['classe'])){
        $pdo= mysqli_connect('localhost','root','','registration');
            ...
            $des = stripslashes($_POST['description']);
            $des = mysqli_real_escape_string($pdo, $des);
            ...
            if(in_array($Ext,$extentionAutoriser)){
                ...
                $insererArticle="INSERT INTO autres_doc(nom,matiere,classe,descriptions,reference) VALUES ('$filename','$username','$userclasse','$des','$useretabli')";
