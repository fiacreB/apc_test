...
if (isset($_POST['Troisieme'])) {
  ...
  $req= $db->prepare('SELECT * FROM documentations WHERE etablissement="Lycée Bilingue de Bonabéri" and classe="Troisième"  ORDER BY matiere ');
  $req->execute();
...
elseif (isset($_POST['Premiere_C'])) {
  ...
  $req= $db->prepare('SELECT * FROM documentations WHERE etablissement="Lycée Bilingue de Bonabéri" and classe="Première C"  ORDER BY matiere ');
  $req->execute();
  while($reponse = $req->fetch(PDO::FETCH_OBJ)){
      ?> 
       <div id="download" class="bg-white my-2">
  ...
  $req= $db->prepare('SELECT * FROM documentations WHERE etablissement="Lycée Bilingue de Bonabéri" and classe="Première D"  ORDER BY matiere ');
  $req->execute();
  while($reponse = $req->fetch(PDO::FETCH_OBJ)){
      ?> 
       <div id="download" class="bg-white my-2">
  ...
  $req= $db->prepare('SELECT * FROM documentations WHERE etablissement="Lycée Bilingue de Bonabéri" and classe="Première TI"  ORDER BY matiere ');
  $req->execute();
  while($reponse = $req->fetch(PDO::FETCH_OBJ)){
      ?> 
       <div id="download" class="bg-white my-2">
  ...
  $req= $db->prepare('SELECT * FROM documentations WHERE etablissement="Lycée Bilingue de Bonabéri" and classe="Première A"  ORDER BY matiere ');
  $req->execute();
  while($reponse = $req->fetch(PDO::FETCH_OBJ)){
      ?> 
       <div id="download" class="bg-white my-2">
  ...
  $req= $db->prepare('SELECT * FROM documentations WHERE etablissement="Lycée Bilingue de Bonabéri" and classe="Terminale C"  ORDER BY matiere ');
  $req->execute();
  while($reponse = $req->fetch(PDO::FETCH_OBJ)){
      ?> 
       <div id="download" class="bg-white my-2">
  ...
  $req= $db->prepare('SELECT * FROM documentations WHERE etablissement="Lycée Bilingue de Bonabéri" and classe="Terminale D"  ORDER BY matiere ');
  $req->execute();
  while($reponse = $req->fetch(PDO::FETCH_OBJ)){
      ?> 
       <div id="download" class="bg-white my-2">
  ...
  $req= $db->prepare('SELECT * FROM documentations WHERE etablissement="Lycée Bilingue de Bonabéri" and classe="Terminale TI"  ORDER BY matiere ');
  $req->execute();
  while($reponse = $req->fetch(PDO::FETCH_OBJ)){
      ?> 
       <div id="download" class="bg-white my-2">
  ...
  $req= $db->prepare('SELECT * FROM documentations WHERE etablissement="Lycée Bilingue de Bonabéri" and classe="Terminale A"  ORDER BY matiere ');
  $req->execute();
  while($reponse = $req->fetch(PDO::FETCH_OBJ)){
      ?> 
       <div id="download" class="bg-white my-2">
...
<?php } 
        ...
        $req= $db->prepare('SELECT * FROM documentations WHERE etablissement="Lycée Bilingue de Bonabéri" ORDER BY classe ');
        $req->execute();
        while($reponse = $req->fetch(PDO::FETCH_OBJ)){
            ?> 
             <div id="download" class="bg-white my-2">
