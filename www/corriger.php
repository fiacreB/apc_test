...
<nav class="mc-navbar navbar navbar-expand-lg position-fixed navbar-dark pe-3 w-100">
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbar">
          <ul class="navbar-nav ms-auto mb-2 mb-lg-0">   
            <li class="nav-item pe-3"><a href="index_admin.php" class="nav-link active " aria-current="page"> Acceuil</a>
            </li>
    ...
    <section class="banner d-flex  align-items-center pt-">
      ...
      <h1 class="title-niv-1 text-white">publier le corrigé d'une épreuve :</h1>
...
if (isset($_POST['Troisieme'])) {
  extract($_POST);
  $req= $db->prepare('SELECT * FROM documentations WHERE classe="Troisième"  ORDER BY etablissement ');
  $req->execute();
       ...
       <div  class="serif mx-2 py-0 my-0">
                ...
                <b><u><p class="vert"><?php echo $reponse->etablissement;?></p></u></b>
                 ...
                 <div id="download_epreuve">         
                  <a href="publier_corrige.php?id=<?php echo $reponse->id;?>"><button class="btn btn-primary">inserer le corrigé</button></a> <br>
...
elseif (isset($_POST['Premiere_C'])) {
  extract($_POST);
  $req= $db->prepare('SELECT * FROM documentations WHERE  classe="Première C"  ORDER BY etablissement');
  $req->execute();
  while($reponse = $req->fetch(PDO::FETCH_OBJ)){
      ?> 
       <div id="download" class="bg-white my-2">
  ...
  extract($_POST);
  $req= $db->prepare('SELECT * FROM documentations WHERE  classe="Première D"  ORDER BY etablissement');
  $req->execute();
  while($reponse = $req->fetch(PDO::FETCH_OBJ)){
      ?> 
       <div id="download" class="bg-white my-2">
  ...
  extract($_POST);
  $req= $db->prepare('SELECT * FROM documentations WHERE classe="Première TI"  ORDER BY etablissement');
  $req->execute();
  while($reponse = $req->fetch(PDO::FETCH_OBJ)){
      ?> 
       <div id="download" class="bg-white my-2">
  ...
  extract($_POST);
  $req= $db->prepare('SELECT * FROM documentations WHERE  classe="Première A"  ORDER BY etablissement');
  $req->execute();
  while($reponse = $req->fetch(PDO::FETCH_OBJ)){
      ?> 
       <div id="download" class="bg-white my-2">
  ...
  extract($_POST);
  $req= $db->prepare('SELECT * FROM documentations WHERE  classe="Terminale C"  ORDER BY etablissement');
  $req->execute();
  while($reponse = $req->fetch(PDO::FETCH_OBJ)){
      ?> 
       <div id="download" class="bg-white my-2">
  ...
  extract($_POST);
  $req= $db->prepare('SELECT * FROM documentations WHERE  classe="Terminale D"  ORDER BY etablissement');
  $req->execute();
  while($reponse = $req->fetch(PDO::FETCH_OBJ)){
      ?> 
       <div id="download" class="bg-white my-2">
  ...
  extract($_POST);
  $req= $db->prepare('SELECT * FROM documentations WHERE  classe="Terminale TI"  ORDER BY etablissement');
  $req->execute();
  while($reponse = $req->fetch(PDO::FETCH_OBJ)){
      ?> 
       <div id="download" class="bg-white my-2">
  ...
  extract($_POST);
  $req= $db->prepare('SELECT * FROM documentations WHERE  classe="Terminale A"  ORDER BY etablissement');
  $req->execute();
  while($reponse = $req->fetch(PDO::FETCH_OBJ)){
      ?> 
       <div id="download" class="bg-white my-2">
...
$req = $db->prepare('SELECT * FROM documentations WHERE classe LIKE ? or etablissement LIKE ? or matiere LIKE ? or descriptions LIKE ?  ORDER BY etablissement DESC');
...
<?php } 
          ...
          $req= $db->prepare('SELECT * FROM documentations  ORDER BY etablissement ');
        $req->execute();
        while($reponse = $req->fetch(PDO::FETCH_OBJ)){
            ?> 
             <div id="download" class="bg-white my-2">
