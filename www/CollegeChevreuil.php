...
if (isset($_POST['Troisieme'])) {
  extract($_POST);
  $req= $db->prepare('SELECT * FROM documentations WHERE etablissement="Collège Chevreuil" and classe="Troisième"  ORDER BY matiere ');
  $req->execute();
...
elseif (isset($_POST['Premiere_C'])) {
  extract($_POST);
  $req= $db->prepare('SELECT * FROM documentations WHERE etablissement="Collège Chevreuil" and classe="Première C"  ORDER BY matiere ');
  $req->execute();
  while($reponse = $req->fetch(PDO::FETCH_OBJ)){
      ?> 
       <div id="download" class="bg-white my-2">
  ...
  extract($_POST);
  $req= $db->prepare('SELECT * FROM documentations WHERE etablissement="Collège Chevreuil" and classe="Première D"  ORDER BY matiere ');
  $req->execute();
  while($reponse = $req->fetch(PDO::FETCH_OBJ)){
      ?> 
       <div id="download" class="bg-white my-2">
  ...
  extract($_POST);
  $req= $db->prepare('SELECT * FROM documentations WHERE etablissement="Collège Chevreuil" and classe="Première TI"  ORDER BY matiere ');
  $req->execute();
  while($reponse = $req->fetch(PDO::FETCH_OBJ)){
      ?> 
       <div id="download" class="bg-white my-2">
  ...
  extract($_POST);
  $req= $db->prepare('SELECT * FROM documentations WHERE etablissement="Collège Chevreuil" and classe="Première A"  ORDER BY matiere ');
  $req->execute();
  while($reponse = $req->fetch(PDO::FETCH_OBJ)){
      ?> 
       <div id="download" class="bg-white my-2">
  ...
  extract($_POST);
  $req= $db->prepare('SELECT * FROM documentations WHERE etablissement="Collège Chevreuil" and classe="Terminale C"  ORDER BY matiere ');
  $req->execute();
  while($reponse = $req->fetch(PDO::FETCH_OBJ)){
      ?> 
       <div id="download" class="bg-white my-2">
  ...
  extract($_POST);
  $req= $db->prepare('SELECT * FROM documentations WHERE etablissement="Collège Chevreuil" and classe="Terminale D"  ORDER BY matiere ');
  $req->execute();
  while($reponse = $req->fetch(PDO::FETCH_OBJ)){
      ?> 
       <div id="download" class="bg-white my-2">
  ...
  extract($_POST);
  $req= $db->prepare('SELECT * FROM documentations WHERE etablissement="Collège Chevreuil" and classe="Terminale TI"  ORDER BY matiere ');
  $req->execute();
  while($reponse = $req->fetch(PDO::FETCH_OBJ)){
      ?> 
       <div id="download" class="bg-white my-2">
  ...
  extract($_POST);
  $req= $db->prepare('SELECT * FROM documentations WHERE etablissement="Collège Chevreuil" and classe="Terminale A"  ORDER BY matiere ');
  $req->execute();
  while($reponse = $req->fetch(PDO::FETCH_OBJ)){
      ?> 
       <div id="download" class="bg-white my-2">
...
<?php } 
          ...
          $req= $db->prepare('SELECT * FROM documentations WHERE etablissement="Collège Chevreuil" ORDER BY classe ');
        $req->execute();
        while($reponse = $req->fetch(PDO::FETCH_OBJ)){
            ?> 
             <div id="download" class="bg-white my-2">
